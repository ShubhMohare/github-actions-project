...
# Java CI/CD Pipeline using GitHub Actions and Tomcat

## Project Overview

This project demonstrates CI/CD deployment of a Java application using GitHub Actions and Apache Tomcat.
